...
All output() methods support embedded methods: sub(), sup(), chr().
...
Allows assigning attributes to a string.

The first argument is the string. The rest makeup a hash of attribute name and value pairs.
